...
public class LocalExecutorInfoParser extends XMLExecutorInfoParser<LocalExecutorInfo> {
	...
	public LocalExecutorInfo parseElement(Element el, String watchdogBaseDir, Object[] additionalData) {
		...
		LocalExecutorInfo info =  new LocalExecutorInfo(this.getNameOfParseableTag(), di.getName(), di.isDefaultExecutor(), false, null, di.getMaxSimRunning(), di.getWatchdogBaseDir(), di.getEnv(), di.getWorkingDir(), di.getShebang(), di.getBeforeScriptNames(), di.getAfterScriptNames(), di.getPackageManagers(), di.getContainer());
