...
/**
 * Validates different aspects of Watchdog modules
 * @author Michael Kluge
 *
 */
public class ModuleValidatorRunner extends BasicRunner {
		
	public static void main(String[] args) {
		Logger log = new Logger(LogLevel.INFO);
		ModuleValidatorParameters params = new ModuleValidatorParameters();
