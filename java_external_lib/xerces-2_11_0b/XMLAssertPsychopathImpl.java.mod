...
public class XMLAssertPsychopathImpl extends XMLAssertAdapter {
    ...
    private final String TAG_PLACEHOLDER_REGEX = "\\{\\$tag\\}";
    ...
    */
    ...
    private void reportAssertionsError(AssertionError assertError) {
        ...
        if (message != null) {
           ...
           // substitue name of tag; modified by michael kluge
           message = message.replaceAll(TAG_PLACEHOLDER_REGEX, elemErrorAnnotation);
